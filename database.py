...
MAX_ROWS     = 10000  # Override Supabase default 1000-row limit
...
def get_all_transactions(filters=None):
    ...
    # ✅ Override 1000-row default limit
...
def ingest_excel(df, mode="add_new"):
    ...
    # Get ALL existing barcodes (with limit override)
    ...
    for _, row in df.iterrows():
        ...
        # ✅ Insert in batches of 50 to stay well under limits
        if len(batch) >= 50:
...
def get_dashboard_stats():
    ...
    # ✅ Use limit override for all queries
...
def delete_all_transactions():
    """Delete all transactions in paginated batches to bypass 1000-row limit."""
    sb = get_client()
    while True:
